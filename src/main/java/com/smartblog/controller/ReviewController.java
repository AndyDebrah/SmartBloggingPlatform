...
public class ReviewController {
    ...
    public CompletableFuture<ResponseEntity<ApiResponse<Map<String, Object>>>> getPostRatingStats(@PathVariable Long postId) {
        ...
        return runAsync(() -> {
            try {
                ...
                return ResponseEntity.ok(ApiResponse.success("Rating statistics retrieved", stats));
            } catch (NotFoundException e) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body(ApiResponse.notFound(e.getMessage()));
            }
    ...
    public ResponseEntity<ApiResponse<ReviewDTO>> getReviewById(@PathVariable Long id) {
        ...
        return reviewService.getReviewById(id)
                .map(reviewDTO -> ResponseEntity.ok(ApiResponse.success("Review found", reviewDTO)))
    ...
    public ResponseEntity<ApiResponse<ReviewDTO>> updateReview(
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("Review updated successfully", reviewDTO));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body(ApiResponse.error(e.getMessage()));
        } catch (NotFoundException e) {
    ...
    public ResponseEntity<ApiResponse<Void>> deleteReview(@PathVariable Long id) {
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.<Void>success("Review deleted successfully"));
        } catch (NotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(ApiResponse.notFound(e.getMessage()));
        }
    ...
    /**
     * Runtime toggle used for async A/B comparison and safe rollback.
     */
    ...
    /**
     * Executes supplier on async pool when enabled to reduce servlet thread occupancy.
     */
