...
/**
 * Utility for migrating existing MySQL comments to MongoDB.
 * Run before enabling NoSQL to copy all comments with mysqlId reference tracking.
 */
public class CommentMongoMigrator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSource ds = DataSourceFactory.get(p);
    ...
    /**
     * Migrates all comments from MySQL to MongoDB with index creation.
     * 
     * @param ds DataSource for MySQL connection
     * @param db MongoDB database instance
     * @throws Exception if migration fails
     */
    public static void migrateAll(DataSource ds, MongoDatabase db) throws Exception {
